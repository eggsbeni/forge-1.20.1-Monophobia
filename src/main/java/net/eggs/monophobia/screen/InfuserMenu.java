...
public class InfuserMenu extends AbstractContainerMenu {
    ...
    public InfuserMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.INFUSER_MENU.get(), pContainerId);
        ...
        // the thing below determines where the slots are on the menu,

        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(iItemHandler -> {
            this.addSlot(new SlotItemHandler(iItemHandler, 0, 64, 36));
            this.addSlot(new SlotItemHandler(iItemHandler, 1, 82, 36));
            this.addSlot(new SlotItemHandler(iItemHandler, 2, 100, 36));
            this.addSlot(new SlotItemHandler(iItemHandler, 3, 150, 36));
            this.addSlot(new SlotItemHandler(iItemHandler, 4, 32, 11));
        });
    ...
    // these things are meant for showing the inventory and hotbar in the gui screen for the infuser (25:31 in the block entity lecture for more)
    // you will most likely have to play with the numbers to fit the bounds of your menu
