package net.eggs.monophobia.datagen.custom;
...
public class InfuserRecipeBuilder implements RecipeBuilder {
    ...
    public InfuserRecipeBuilder(ItemLike ingredient, ItemLike result, int count) {
    ...
    public static class Result implements FinishedRecipe {
        ...
        public ResourceLocation getId() {
            return new ResourceLocation(Monophobiamod.MOD_ID,
                    ForgeRegistries.ITEMS.getKey(this.result).getPath() + "_from_infusing");
        }
